...
SECRET_KEY = '6(l!b@os@#6own-_i4ygf5mwf91#8f1#hyxgp*g@#!byrd!(*!'
...
INSTALLED_APPS = [
    ...
    'ddm','member','board','message','alarm','review','qna'

    # 아래꺼를 추가한후에 HTML에 {% load humanize %} 를 추가하면 {{ 500000|intcomma }} 이렇게 콤마 표시할수 있음.
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'ddm/templates'),
                ...
                os.path.join(BASE_DIR,'alarm/templates'),
